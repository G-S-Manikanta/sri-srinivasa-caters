...
export class PopularMenuComponent {
  readonly activeCategory = signal('traditional-meals');

  readonly categories: MenuCategoryItem[] = [
    {
      id: 'traditional-meals',
      name: 'Traditional Meals',
      icon: 'fas fa-leaf',
      kicker: 'SACRED FEAST COURSES',
      items: [
        { name: 'Royal Kalyana Virundhu (24 Items)', description: 'Grand wedding banquet featuring 3 sweets, 4 savouries, 5 curries, rice, sambar, rasam, and elaneer payasam.', isSignature: true, tag: 'Royal Wedding' },
        { name: 'Aru Suvai Bhojanam (18 Items)', description: 'Traditional South Indian festive meal balancing all six ayurvedic tastes on fresh banana leaf.', isSignature: true, tag: 'Festive Classic' },
        { name: 'Satvik Puja Prasada Bhojanam', description: 'Pure temple-style meal prepared without onion and garlic according to sacred Vedic sanctity.', tag: 'Satvik Purity' },
        { name: 'Seemantham 5 Variety Rice Virundhu', description: 'Traditional ceremony feast featuring 5 signature chitrannam preparations with crunchy vadam.', tag: 'Ceremonial' }
      ]
    },
    {
      id: 'breakfast',
      ...
      icon: 'fas fa-sun',
      kicker: 'SUNRISE AUSPICIOUS FEAST',
      items: [
        { name: 'Ghee Podi Thatte Idli', description: 'Steamed fluffy rice cakes bathed in freshly roasted spice gunpowder and melted cow ghee.', isSignature: true, tag: 'Signature' },
        { name: 'Crispy Medu Vadai', description: 'Golden, crunchy whole urad dal fritters with cracked black pepper and fresh coconut chutney.' },
        { name: 'Ghee Roast Paper Dosa', description: 'Golden wafer-thin fermented crepes roasted in pure cow ghee with heirloom potato masala.' },
        { name: 'Rava Kichadi & Sambar', description: 'Semolina cooked with garden vegetables, roasted cashews, and aromatic spices.' }
      ]
    },
    {
      id: 'rice-varieties',
      ...
      items: [
        ...
        { name: 'Bisibelebath with Ghee Boondi', description: 'Karnataka classic rice and lentil mash slow-cooked with fresh vegetables and rich spice blend.' },
        { name: 'Elumichai Sadham (Lemon Rice)', description: 'Zesty turmeric and lemon infused rice with crunchy lentils, green chilies, and fresh ginger.' },
        { name: 'Thengai Sadham (Coconut Rice)', description: 'Fragrant aged rice tossed with fresh grated coconut, cashews, and aromatic curry leaves.' }
      ]
    },
    {
      id: 'curries',
      ...
      items: [
        ...
        { name: 'Paneer Butter Masala (South Style)', description: 'Fresh paneer cubes in a spiced cashew-tomato reduction with a delicate South Indian touch.' }
      ]
    },
    {
      id: 'sambar-rasam',
      ...
      items: [
        ...
        { name: 'Mysore Tomato Rasam', description: 'Clarified digestive broth infused with heirloom tomatoes, cumin, crushed pepper, and cow ghee.' },
        ...
        { name: 'Mor Kulambu', description: 'Cooling yogurt gravy simmered with white ash gourd and tempered with cumin and curry leaves.' }
      ]
    },
    {
      id: 'side-dishes',
      name: 'Side Dishes & Avial',
      icon: 'fas fa-carrot',
      kicker: 'CRISP & CREAMY ACCENTS',
      items: [
        ...
        { name: 'Seppankizhangu Varuval (Taro Roast)', description: 'Crisp, spicy roasted taro root seasoned with red chili, hing, and curry leaves.' },
        { name: 'Vazhaipoo Vadai', description: 'Delicate, crunchy fritters made from freshly cleaned banana blossoms and chana dal.' }
      ]
    },
    {
      id: 'sweets',
      ...
      kicker: 'DIVINE AUSPICIOUS DESSERTS',
      items: [
        ...
        { name: 'Kashi Halwa', description: 'Rich, translucent ash gourd halwa cooked with ghee, sugar, and toasted cashews.' }
      ]
    },
    {
      id: 'snacks',
      ...
      icon: 'fas fa-cookie',
      kicker: 'CRISPY WEDDING SAVOURIES',
      items: [
    ...
    },
    {
      ...
      kicker: 'TRADITIONAL REFRESHMENTS',
      items: [
        { name: 'Brass Davarah Filter Coffee', description: 'Freshly roasted chicory blend decoction frothed with whole milk in traditional brass davarah-tumbler.', isSignature: true, tag: 'Iconic' },
